...
extern "C" {
#endif
void  hsM_0_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_0_6(UB  * pcode, scalar  val, U  I818);
void  hsM_0_7(UB  * pcode, vec32  * I957, U  I818, U  I968);
void  hsM_0_9(UB  * pcode, vec32  * I773);
void  hsM_1_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_1_5(UB  * pcode, U  I716);
void  hsM_2_0(UB  * pcode, scalar  val);
void  hsM_3_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_3_5(UB  * pcode, U  I716);
void  hsM_4_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_5_0(UB  * pcode, scalar  val);
void  hsM_5_5(UB  * pcode, UB  val);
void  hsM_6_0(UB  * pcode, scalar  val);
void  hsM_7_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_8_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_8_5(UB  * pcode, U  I716);
void  hsM_9_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_10_0(UB  * pcode, scalar  val);
void  hsM_11_0(UB  * pcode, scalar  val);
void  hsM_11_5(UB  * pcode, UB  val);
void  hsM_12_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_12_5(UB  * pcode, U  I716);
void  hsM_13_0(UB  * pcode, scalar  val);
void  hsM_14_0(UB  * pcode, scalar  val);
void  hsM_15_0(UB  * pcode, vec32  * I773, U  I716);
void  hsM_15_5(UB  * pcode, U  I716);
