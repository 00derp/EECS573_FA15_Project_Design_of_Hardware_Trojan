...
set icache_module [getenv ICACHEMEM_NAME]
set dcache_module [getenv DCACHEMEM_NAME]
set victim_cache_module [getenv VICTIM_CACHE_NAME]

#set core_module [getenv CORE_NAME]
read_file -f ddc [list ${icache_module}.ddc]
read_file -f ddc [list ${dcache_module}.ddc]
read_file -f ddc [list ${victim_cache_module}.ddc]
#set_dont_touch ${core_module}
